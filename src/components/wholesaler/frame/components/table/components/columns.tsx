...
import { frameProductTableColumnsName } from '@/components/frame/data';
...
export const makeProductTableColumns = (
  ...
  const columns: Column<ProductTable>[] = [
    ...
    {
      id: 'image',
      label: frameProductTableColumnsName['image'],
      width: 120,
      align: 'center',
      sortable: false,
      render: (v) => {
    ...
    { id: 'model', label: frameProductTableColumnsName['model'], align: 'right' },
    {
      id: 'actions',
      label: frameProductTableColumnsName['actions'],
      align: 'center',
      width: 110,
      sortable: false,
      render: (_v, row) => (
